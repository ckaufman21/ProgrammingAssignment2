...
makeCacheMatrix <- function(x = matrix()) {
    ...
    setinv <- function(inverse) i <<- inverse   # Function 'setinv' takes a value ('inverse') and sets it to the value of 'i'
    getinv <- function() i                      # in the makeCacheMatrix environment. Function 'getinv' returns the value of 'i'.
...
cacheSolve <- function(x, ...) {
    ...
    x$setinv(i)                                 # function. Assign the calculated inverse to the 'x' environment using 'setinv'
